...
const CategoryPage = () => {
  ...
  const { data: category, isError, isLoading } = useCategoryDetailsQuery(categorySlug)
      ...
      <div className="mt-24 section-content">
        ...
        <div className="mt-36 bg-accent space-y-4 flex flex-col items-center p-8 rounded-lg">
          ...
          <p className="text-muted-foreground text-body-lg">
            Skontaktuj się z nami, a pomożemy Ci znaleźć odpowiedniego specjalistę lub dodamy nową
            usługę do naszej platformy.
          </p>
