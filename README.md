...
The frontend is built with **React**, **TypeScript**, **Tailwind CSS**, **shadcn/ui**, **Zustand**, and **TanStack
Query & Router**, focusing on modern architecture, performance, and reusability.
...
| Forms            | React Hook CreationForm + Zod        |
...
Each feature (e.g., `auth`, `chat`, `job-request`, `category`) contains its own components, hooks, stores, and API
logic.
...
- **Backend (Spring Boot + DDD + Hexagonal Architecture)
  ** → [craftlink-backend](https://github.com/ajzyn/craftlink-backend)
